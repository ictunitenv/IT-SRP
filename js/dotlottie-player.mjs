import {a as a$2, b, c as c$1} from './chunk-6BVPVBJE.mjs';
import {a as a$1, c, e, f, g as g$1, i, j} from './chunk-ZDBUHXQ5.mjs';
...
var u = ({finisher: s, descriptor: t}) => (e, i) => {
    var o;
    if (i === void 0) {
        let d = (o = e.originalKey) !== null && o !== void 0 ? o : e.key,
            m = t != null ? {kind: "method", placement: "prototype", key: d, descriptor: t(e.key)} : {...e, key: d};
...
var r = class extends b {
    ...
    _handleSeekChange(t) {
        ...
        try {
            ...
            throw a$1("Error while seeking animation")
        }
    }
    ...
    _initListeners() {
        ...
        this._unsubscribeListeners = t.state.subscribe((e$1, i) => {
            ...
            })), this.dispatchEvent(new CustomEvent(e.VisibilityChange, {detail: {visibilityPercentage: e$1.visibilityPercentage}}));
    ...
    getVersions() {
        return {lottieWebVersion: j.getLottieWebVersion(), dotLottiePlayerVersion: `${P.version}`}
    }
    ...
    async firstUpdated() {
        this.container = this.shadowRoot?.querySelector("#animation"), "IntersectionObserver" in window && (this._io = new IntersectionObserver(t => {
            t[0] !== void 0 && t[0].isIntersecting ? this._dotLottieCommonPlayer?.currentState === f.Frozen && this.play() : this._dotLottieCommonPlayer?.currentState === f.Playing && this._freeze();
    ...
    renderControls() {
        let t = this._dotLottieCommonPlayer?.currentState === f.Playing,
            e = this._dotLottieCommonPlayer?.currentState === f.Paused;
        return a$2`
